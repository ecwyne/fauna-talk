...
Fauna Dashboard: [dashboard.fauna.com](https://dashboard.fauna.com)

Fauna Docs: [docs.fauna.com](https://docs.fauna.com)

Commission Buddies: [commissionbuddies.com](https://commissionbuddies.com)

Sign Up: [bit.ly/commbuds-nextjs](https://bit.ly/commbuds-nextjs)

Slides: [nextjs-conf-fauna.vercel.app](https://nextjs-conf-fauna.vercel.app)
